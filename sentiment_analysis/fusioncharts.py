...
class FusionCharts:
   ...
   """
    ...
    def render(self):
        ...
        self.readyJson = FusionCharts.constructorTemplate.replace(
            "__constructorOptions__", self.readyJson
        )
        self.readyJson = self.readyJson + FusionCharts.renderTemplate.replace(
            "__chartId__", self.constructorOptions["id"]
        )
