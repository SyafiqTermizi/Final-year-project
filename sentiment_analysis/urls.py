...
urlpatterns = [
    ...
    url(
        r"^saved_user_tweets/(?P<userId>[0-9]+)/$",
        views.saved_tweets,
        name="saved_user_tweets",
    ),
    url(
        r"^saved_keyword_tweets/(?P<keyword>[#?\w+\s\w+]+)/$",
        views.saved_keyword_tweets,
        name="saved_keyword_tweets",
    ),
    url(
        r"^analyse_tweets/(?P<analysis_item>[#?\w+\s\w+]+)/$",
        views.analyse_tweets,
        name="analyse_tweets",
    ),
]
